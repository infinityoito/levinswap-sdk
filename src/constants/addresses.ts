...
export const FACTORY_ADDRESS: AddressMap = {
  ...
  [ChainId.XDAI]: '0x965769C9CeA8A7667246058504dcdcDb1E2975A5', // xDai only (for now)
...
export const ROUTER_ADDRESS: AddressMap = {
  ...
  [ChainId.XDAI]: '0xb18d4f69627F8320619A696202Ad2C430CeF7C53', // xDai only (for now)
...
export const SUSHI_ADDRESS: AddressMap = {
  ...
  [ChainId.XDAI]: '0x1698cD22278ef6E7c0DF45a8dEA72EDbeA9E42aa', // xDai only (for now)
...
export const MASTERCHEF_ADDRESS: AddressMap = {
  ...
  [ChainId.XDAI]: '0x0f2B0e9DB46C6b538e9276D2cF0C6CE8d515Eca1' // xDai only (for now)
}
...
export const BAR_ADDRESS: AddressMap = {
  ...
  [ChainId.XDAI]: '0xafa57Fb9d8D63Ff8124E17c1495C73bc3a7678D0' // xDai only (for now)
}
...
export const MAKER_ADDRESS: AddressMap = {
  ...
  [ChainId.XDAI]: '0x6d81DDa24b7fF5B4a65039ff15d06a076e018E49' // xDai only (for now)
}
